...
def getdata(request):
    ...
    if(request.method=='POST'):
        ...
        if request.POST.get('cex'):
            ...
            # print("done")
            # print(chart)
            return render(request,"base.html",{'json_data': context})
        else:
            return render(request,"error.html")


def getdatabuysell(request):
    global chartdata, cex_state, offset_state
    if(request.method=='POST'):
        ...
        if request.POST.get('cex'):
            ...
            buy_sell_signal_latest=max(-1,min(1,round(buy_sell_signal[-1],3)))
            offset=-21.6
            offset_state=str(buy_sell_signal_latest*20+offset)+"vw"
            dictionary=get_training_results()
            training_generation=dictionary["generation"]
            training_results=dictionary["result"]
            # print(training_results)
            ...
            # print("done")
            # print(chart)
            return render(request,"buy_sell_signal.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
        else:
            return render(request,"buy_sell_signal.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
    return render(request,"buy_sell_signal.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
...
def getdatacurrencychart(request):
    global chartdata,cex_state,offset_state
    if(request.method=='POST'):
        ...
        if request.POST.get('cex'):
            ...
            # print("done")
            # print(chart)
            return render(request,"currency_chart.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
        else:
            return render(request,"currency_chart.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
    return render(request,"currency_chart.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})

        
def getdatatrainingresult(request):
    global chartdata, cex_state, offset_state
    if(request.method=='POST'):
        ...
        if request.POST.get('cex'):
            ...
            buy_sell_signal_latest=max(-1,min(1,round(buy_sell_signal[-1],3)))
            offset=-21.6
            offset_state=str(buy_sell_signal_latest*17.5+offset)+"vw"
            dictionary=get_training_results()
            training_generation=dictionary["generation"]
            training_results=dictionary["result"]
            # print(training_results)
            ...
            # print("done")
            # print(chart)
            return render(request,"Training_results.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
        else:
            return render(request,"Training_results.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
    return render(request,"Training_results.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
...
def getdataperformance(request):
    global chartdata, cex_state, offset_state
    if(request.method=='POST'):
        ...
        if request.POST.get('cex'):
            ...
            # print("done")
            # print(chart)
            return render(request,"performance.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
        else:
            return render(request,"performance.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
    return render(request,"performance.html",{'json_data': chartdata, "cex_state":cex_state, "offset":offset_state})
